  ...
  return (
    <div className="max-w-4xl space-y-8">
      ...
      <section className="space-y-4">
        ...
        <Showcase title="Full-Width Divider" className="flex-col items-stretch">
      ...
      <section className="space-y-4">
        ...
        <Showcase title="Inset Divider" className="flex-col items-stretch">
          <p className="text-sm text-surface-foreground">Content above</p>
      ...
      <section className="space-y-4">
        ...
        <Showcase title="Middle-Inset Divider" className="flex-col items-stretch">
          <p className="text-sm text-surface-foreground">Content above</p>
      ...
      <section className="space-y-4">
        ...
        <Showcase title="Divider in a List" className="flex-col items-stretch">
